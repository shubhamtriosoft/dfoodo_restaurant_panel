...
function ReservationReport() {
  ...
  const [selected2, setIsSelected2] = useState(options_select_report_sales[0]);
  ...
  const master_data_get = async (
    ...
    await server_post_data(get_all_ReportsSales, fd)
      .then((Response) => {
          ...
          <div className="row m-0">
            ...
            >
              <div className="inputDiv2 searchBt2">
                ...
                <input
                  ...
                  placeholder="Guest Name/Bill No/Phone No."
            ...
            <div className="col-xl-2 col-md-4 paddingLeft0 bottomAlgin">
              <div className="dropdownCustom " ref={dropdownRef2}>
                ...
                >
                  {options_select_report_sales.map(function (items, index) {
                    return (
                      <div
                        onClick={(e) => {
            ...
            {customDateActive && (
              <>
                ...
                <div className="col-md-1 p-0">
                  ...
                  <div className="paddingBottomUp downloadBtnAna">
          ...
          <div className="resrvReportsCards">
            <div className="row m-0">
              <div className="col-md-3">
                <div className="resrvReportsCards_card">
                  ...
                  <h5>
                    ...
                    {ReservationData.total_sales_amount}
              ...
              <div className="col-md-3">
                <div className="resrvReportsCards_card">
                  <p>Number of Sales </p>
                  <h5>{ReservationData.total_sales_count}</h5>
                </div>
              </div>
              <div className="col-md-3">
                <div className="resrvReportsCards_card">
              ...
              <div className="col-md-3">
                <div className="resrvReportsCards_card">
                  <p>Total Covers</p>
                  <h5>{ReservationData.total_cover_count}</h5>
                </div>
              </div>
            </div>
          </div>
