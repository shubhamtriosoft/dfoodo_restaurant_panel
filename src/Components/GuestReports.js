...
function GuestReport() {
  ...
  const [selected2, setIsSelected2] = useState(options_select_report_guest[0]);
  ...
  const master_data_get = async (
    ...
    await server_post_data(get_all_guestReport, fd)
      .then((Response) => {
    ...
    <div className="resvReports">
      ...
      <div className="resvReports_container">
          ...
          <div className="row m-0">
            ...
            >
              <div className="inputDiv2 searchBt2">
                ...
                <input
                  ...
                  placeholder="Guest Name/Phone No./E-MAIL"
            ...
            <div className="col-xl-2 col-md-4 paddingLeft0 bottomAlgin">
              <div className="dropdownCustom " ref={dropdownRef2}>
                ...
                >
                  {options_select_report_guest.map(function (items, index) {
                    return (
                      <div
                        onClick={(e) => {
        ...
        <div className="resrvReposrt_body">
          <div className="feedBackTable mt-4">
                            ...
                            <td>
                              <div className="guest_incenter borderRightRadius">
                                <button
                                  ...
                                  onClick={() =>
                                    handleEmailClick(item.guest_email)
                                  }
                                >
                                  <img src={Email} alt="Barley's Dashboard" />
                                  <p>{GuestManagementPageText.Send_Email}</p>
                                </button>
                              </div>
                            </td>
                          </tr>
